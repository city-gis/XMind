...
<body class="gray-bg">
					...
					<div class="ibox-title">
						...
						<a style="padding: 5px 15px;" onclick="fnAdd();"
							...
							href="javascript:void(0);"><i class="fa fa-cogs"></i> 分配角色</a>
							 <a
							style="padding: 5px 15px;" onclick="fnSetbumen();"
							href="javascript:void(0);"><i class="fa fa-cogs"></i> 分配部门</a>
						<div class="ibox-tools">
							<a class="collapse-link"> <i class="fa fa-chevron-up"></i>
							</a>
    ...
    <div class="jqGrid_wrapper" id="menu_showwin_depart" style="display:none;">
		<table id="table_list_departs"></table>
		<!-- <div id="pager_list_2"></div> -->
	</div>
	...
	<script src="${pageContext.request.contextPath}/js/page/sys_users_view.js"></script>
