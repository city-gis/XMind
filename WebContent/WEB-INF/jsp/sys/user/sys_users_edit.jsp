			...
			<div class="col-sm-12">
				<form class="form-horizontal m-t" id="signupForm"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<input name ="userid" type ="hidden" value="${ sys_users.userid}"/>
							<input id="username" name="username" class="form-control"  value="${sys_users.username }"
								aria-required="true" aria-invalid="true" type="text">
						</div>
						<label class="col-sm-2 control-label">排序：</label>
						<div class="col-sm-4">
							<input id="orderby" name="orderby" class="form-control"
							 value="${ sys_users.orderby}"	type="text" aria-required="true" aria-invalid="true"
								class="valid">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<input type ="hidden" id = "hdcheckDisplay" value="${sys_users.isused}">
						<label class="col-sm-2 control-label">状态：</label>
						<div class="col-sm-4 col-sm-offset-3"
							style="margin-left: 0px !important;">
							<input type="hidden" name="display" id="display" value="${sys_users.isused}" />
							<div class="switch">
								<div class="onoffswitch">
									<input type="checkbox" ${sys_users.isused==0?'checked':'' }
					...
					<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="img"  value="${sys_users.description}"	 name="description" class="form-control">
							</div>
					</div>
					<div class="form-group">
						<div class="col-sm-4 col-sm-offset-3">
