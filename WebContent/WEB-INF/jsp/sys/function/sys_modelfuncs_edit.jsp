...
<title>方法管理修改</title>
<meta name="keywords" content="方法管理修改">
			...
			<div class="col-sm-12">
				<form class="form-horizontal m-t" id="signupForm"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<input name =funcid type ="hidden" value="${ sys_modelfuncs.funcid}"/>
							<input id="funcname" name="funcname" class="form-control"  value="${sys_modelfuncs.funcname }"
								aria-required="true" aria-invalid="true" type="text">
						</div>
						
						<label class="col-sm-2 control-label">模块：</label>
						<div class="col-sm-4">
							<input id="modelname" name="modelname" value="${ sys_modelfuncs.modelname}" class="form-control"
								readonly type="text" aria-required="true" aria-invalid="true"
								class="valid">
								<input id="modelid" name="modelid"  value="${ sys_modelfuncs.modelid}" class="form-control"
					...
					<label class="col-sm-2 control-label">图标：</label>
						<div class="col-sm-4">
							...
							readonly value="${ sys_modelfuncs.icon}"	type="text" aria-required="true" aria-invalid="true"
								class="valid">
						</div>
						<label class="col-sm-2 control-label">地址：</label>
						<div class="col-sm-4">
							<input id="url" name="url" class="form-control"
							 value="${ sys_modelfuncs.url}"	type="text" aria-required="true" aria-invalid="true"
								class="valid">
						</div>
					</div>
					...
					<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="description"  value="${sys_modelfuncs.description}"	 name="description" class="form-control">
							</div>
					</div>
					<div class="form-group">
	...
	*/
	function postForm(form){
		$(form).ajaxSubmit({
            ...
            url: '${pageContext.request.contextPath}/sys_modelfuncs/edit.do', // 需要提交的 url,
			            ...
			            success: function (layero, index) {
			            	$("#using_json").jstree({
			                    "core": {
			                        "check_callback": true,
			                        "data": {
			                            'url': '${pageContext.request.contextPath}/sys_models/models_Tree.do',
			                            'dataType': 'json',
			                        }
			                    }
			                });
