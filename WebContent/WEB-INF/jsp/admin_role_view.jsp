			...
			<div class="modal-dialog modal-lg" style="width: 100%; height: 85%;">
				<div class="modal-content animated flipInY" style="height: 80%">
					...
					<iframe id="frameView" src=""
						...
						<input type="button" id="reloadGrid" style="status:none" onclick="reloadGrid();">
				</div>
			</div>
		</div>
    ...
    <script src="../js/plugins/toastr/toastr.min.js"></script>
		<script>
				...
				*/
				...
				$("#table_list_2").jqGrid("navGrid", "#pager_list_2", {
					...
					editfunc : function(id) {
	                    ...
	                    var roleid = $currRow.find("td:eq(1)").text();
	                    console.log(roleid);
						editdata(roleid);
					},
					addfunc : function(id) {
			...
			function editdata(id) {
				//alert(id);
				$("#frameView").attr("src", "../admin_role/edit_view.do?id="+id);
				$('#addmodal').modal({
					keyboard : true
				});
			}
			 ...
			 */
			function adddata() {
				$("#frameView").attr("src", "../admin_role/add_view.do");
				$('#addmodal').modal({
					keyboard : true
				});
			}
