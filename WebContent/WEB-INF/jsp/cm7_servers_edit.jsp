		...
		<div class="row">
			<div class="col-sm-12">
				<form class="form-horizontal m-t" id="signupForm"
					action="../cm7_servers/add.do">
					<div class="form-group">
						<label class="col-sm-2 control-label">名称：</label>
						<div class="col-sm-4">
						<input name ="id" type ="hidden" value="${ cm7_servers.id}"/>
							<input id="name" name="name" class="form-control"  value="${cm7_servers.name }"
						...
						<div class="col-sm-4">
							<input id="ip" name="ip" class="form-control"
								 aria-required="true" aria-invalid="true" value="${ cm7_servers.ip}" type="text">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input id="port" name="port" class="form-control"
							 value="${ cm7_servers.port}"		type="text">
						</div>
					...
					<label class="col-sm-2 control-label">描述：</label>
						<div class="col-sm-4">
							<input id="desc" name="desc" class="form-control"
								 value="${ cm7_servers.desc}"	 type="text">
						</div>
	...
	*/
	function postForm(form){
		$(form).ajaxSubmit({
            ...
            url: '../cm7_servers/edit.do', // 需要提交的 url,
