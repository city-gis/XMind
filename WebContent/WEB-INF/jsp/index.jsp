...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="${pageContext.request.contextPath}/loginout.do" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
    ...
    <script src="${pageContext.request.contextPath}/js/index.js"></script> 		$("..sidebar-collapse>.jstree-default .jstree-node")
    	})
    </script>
</body>
